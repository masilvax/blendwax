...
if (!isset($_GET['oauth_verifier'])) {
    ...
    $result = $oauthObject->sign(array(
        ...
        'parameters'=> array(
            'oauth_callback'=> 'http://blendwax.com/oauth/dyskox_oauth.php'),
...
//echo "token: ".$signatures['oauth_token']."---".$_GET['oauth_token']."<br/>secret: ".$signatures['oauth_secret']."---".$_SESSION['oauth_token_secret']."<br/>";
sleep(5);
    ...
    $result = $oauthObject->sign(array(
        ...
        'signatures'=> $signatures));//tu się wywala Richardowi
